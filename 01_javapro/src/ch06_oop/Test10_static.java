...
//static 변수,메서드는 객체생성 않고도 사용가능
// ex : 클래스이름.메서드() => Math.max(6,7)
// ex : 클래스이름.변수		=> Math.PI


public class Test10_static {
	static int a=10;//전역변수, static
	
	public static void aa(){//static메서드
	...
	public static void main(String[] args) {
		System.out.println("a:"+a);//static변수 에러x
		aa();//static메서드 호출
		
		Test10_static test10=new Test10_static();
		test10.bb();//일반메서드, 객체생성하여 호출하면 된다
